...
<ImageLightbox client:load loading="eager" src="/posts/assets/default-margin-card-comparison.png" alt="Two cards placed next to each other. The left card" />
...
<ImageLightbox client:load src="/posts/assets/default-margin-toolbar.png" alt="A toolbar with a search in the middle and two buttons on right. A sign in and a log in button" />
...
<ImageLightbox client:load src="/posts/assets/stack-form.png" alt="A form with three vertically aligned input fields. Each input has a bottom margin of 1rem, except the last one has none." />
...
<ImageLightbox client:load src="/posts/assets/stack-form-with-button.png" alt="A form with three vertically aligned input fields and a button. The input fields have a bottom margin of one rem, except the last one. It has a bottom margin of 2 rem." />
