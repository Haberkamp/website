...
import cardComparison from "./assets/default-margin-card-comparison.png";
import toolbar from "./assets/default-margin-toolbar.png";
import stackForm from "./assets/stack-form.png";
import stackFormWithButton from "./assets/stack-form-with-button.png";
...
<ImageLightbox client:load>
  <Image src={cardComparison} alt="Two cards placed next to each other. The left card" loading="eager" />
</ImageLightbox>
...
<ImageLightbox client:load>
  <Image src={toolbar} alt="A toolbar with a search in the middle and two buttons on right. A sign in and a log in button" />
</ImageLightbox>
...
<ImageLightbox client:load>
  <Image src={stackForm} alt="A form with three vertically aligned input fields. Each input has a bottom margin of 1rem, except the last one has none." />
</ImageLightbox>
...
<ImageLightbox client:load>
  <Image src={stackFormWithButton} alt="A form with three vertically aligned input fields and a button. The input fields have a bottom margin of one rem, except the last one. It has a bottom margin of 2 rem." />
</ImageLightbox>
